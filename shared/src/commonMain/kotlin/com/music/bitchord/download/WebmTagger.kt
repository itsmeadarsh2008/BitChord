...
object WebmTagger {
    ...
    private fun buildTail(
        ...
        if (cover != null && cover.isNotEmpty()) {
            val fileName = elem(ID_FILENAME, "cover.jpg".encodeUtf8())
            val fileMime = elem(ID_FILEMIMETYPE, coverMime.encodeAscii())
    ...
    private fun simpleTag(name: String, value: String): ByteArray {
        val nameElem = elem(ID_TAGNAME, name.encodeAscii())
        val stringElem = elem(ID_TAGSTRING, value.encodeUtf8())
